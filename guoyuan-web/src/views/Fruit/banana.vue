<template>
    <el-scrollbar>
        <el-table :data="tableData">
            ...
            <el-table-column prop="fruitCase" label="水果的种类" width="200" />
            <el-table-column prop="mac" label="第一季度" width="200" />
            <el-table-column prop="season" label="第二季度" width="200" />
            <el-table-column prop="input" label="第三季度" width="200" />
